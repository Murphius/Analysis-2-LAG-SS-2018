\begin{Bemerkung}{
	\begin{itemize}
		...
		\end{align*}
		Das zeigt insbesondere mit Satz~\ref{vl_17_def_2}, \todo{ref prüfen} 
...
\begin{proof}
	Da $f_n'$ gleichmäßig gegen $g$ konvergiert ist $g$ stetig (Satz~\ref{vl_17_def_2}) 
	\todo{ref prüfen}
	Daher gilt nach Satz~\ref{vl_12_satz_01} dass 
	$G(x) = \int_a^b g \dd{t}$ differenzierbar ist und als Ableitung $g$ besitzt. 
	Weiterhin gilt mit Satz~\ref{vl_18_satz_2} \todo{ref prüfen}:
	\begin{align*}
