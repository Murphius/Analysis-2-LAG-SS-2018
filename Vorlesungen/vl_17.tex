...
\begin{Bemerkung}{
	Mit Satz~\ref{vl_17_satz_1} \todo{ref prüfen
eigentliche nr war 10} und Satz~\ref{vl_14_satz_1} \todo{ref prüfen} kennen wir also den kompletten 
...
\begin{Beispiel}{
	...
	\begin{align}
		...
		P \left( \frac{\mathrm{d}}{\mathrm{dt}} \right) y_2(t) = & i \exp(it)
			\label{vl_17_gl_3}
	\end{align}
	Mit Satz~\ref{vl_17_satz_1}(beziehungsweise dessen Beweis), \todo{ref prüfen} sehen wir, dass 
	\begin{align*}
...
\begin{Definition}{
	...
	Funktionen $f_n : D \rightarrow \mathbb{K}$. Wir sagen, $(f_n)$ \highl[Konvergenz!punktweise]{konvergiert 
	Punktweise} gegen $f:D \rightarrow \mathbb{K}$, falls für alle $x \in D$ gilt:
	\begin{align*}
		\lim \limits_{n \rightarrow \infty}{f_n(x) =f(x)}
	\end{align*}
	Analog sagen wir $\sum_{n\geq 1} f_n$ \highl[Konvergenz!punktweise]{konvergiert punktweise} gegen 
...
\begin{Definition}[Gleichmäßige Konvergenz]{\label{def:glm_konv}
	Sei $D \subseteq \mathbb{K}$ und $(f_n)_{n \in \mathbb{N}}$ eine Folge von 
...
\begin{Satz}{\label{vl_17_satz_2} %2
