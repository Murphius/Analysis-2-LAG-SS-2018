...
\begin{Beispiel}{
	...
	\begin{figure}
		...
		\caption{Skizze der Funktion $\frac{1}{x^2}$}
	\end{figure}
	Denn: für $b > 1$ gilt:
	\begin{align*}
...
\begin{enumerate}[resume]
	\item Der Integrand ist an einer Intervallgrenze kritisch (also beispielsweise 
	unbeschränkt).
\end{enumerate}
...
\begin{enumerate}[resume]
	\item Beide Integrationsgrenzen sind kritisch
\end{enumerate}
...
\begin{proof}
	...
	\begin{itemize}
		...
		Wähle $\varphi \in [0, 2\pi)$, so dass:
		\begin{align*}
