...
\centering
	\begin{tikzpicture}
		\draw[very thin, gray] (-0.9,-0.9) grid (4.9,2.9);
		...
		\draw[blue,domain = 0.0:4.0, samples=150]   
       	...
       	\draw[green](0.75,-0.75)--(0.75,2.5)node[above]{a};
       	\draw[red](3,0) -- (3,2) node[above]{b};
       	\draw[black](1.33,2.34079);
       	\draw[orange,domain = 1:2, samples = 150]
       	...
       	\draw[purple,domain = 1.5:2.5, samples = 150]
